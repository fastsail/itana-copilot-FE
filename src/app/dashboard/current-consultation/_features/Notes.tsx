	...
	return (
		<div className='h-full overflow-y-auto'>
			...
			*/}
			<div
				className={cn(
					'bg-[#36A477] px-4 md:px-8 py-2 flex-wrap gap-y-3 mb-4 w-full flex items-center justify-between rounded-md'
				)}
			>
				...
				<button
					...
					className={cn(
						button_styles,
						'bg-[#EEFAEB] flex items-center justify-center gap-2 rounded-md text-xs md:text-sm font-light'
					)}
					type='button'
				>
			...
			*/}
			...
			|--------------------------------------------------
			*/}
			<div className='flex flex-wrap justify-end gap-y-4 items-center gap-x-4 bottom-24 fixed right-4 md:right-8 w-full md:w-[calc(100%_-_324px)]'>
				{/* Rate this note */}
				<button
					className={cn(
						button_styles,
						'text-xs md:text-sm flex-wrap font-light bg-[#F6F7F8] md:mr-auto border rounded-md text-black min-h-[48px] py-3 rounded-l-md flex items-center gap-2 px-8'
					)}
					type='button'
				>
				...
				*/}
				<button
					className={cn(
						button_styles,
						'text-xs md:text-sm font-light md:mr-6 border rounded-md text-black h-[48px] py-3 rounded-l-md flex items-center gap-2 px-8'
					)}
					type='button'
				>
					<span>
